function Unpublish-ALApp
{
    ...
    $dockerapp = Get-BcContainerAppInfo -containerName $ContainerName | where-object {$_.Name -eq $AppName}
    ...
    if ($app) {
        ...
        if ($dockerapp) {
            ...
            Unpublish-BcContainerApp -containerName $ContainerName -appName $AppName -uninstall
        } else {
